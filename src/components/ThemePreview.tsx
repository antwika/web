import { SemanticColorGroupName, themeColorGroupNames, themeColorLevels, ThemeName, ThemeProvider, themes } from "../context/ThemeContext";
...
const ThemePreview = ({ themeName }: Props) => {
